...
class EncounterSeederKillPlayer extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($games as $game) {
            ...
            foreach($fleets as $index => $fleet) {
                ...
                // 2 cruisers, 4 destroyers for third fleet
                if ($index === 2) {
            ...
            foreach($fleets as $index => $fleet) {
                ...
                // 6 cruisers, 6 destroyers for third fleet
                if ($index === 2) {
                    $className = 'CG-'.strtoupper(Str::random(3));
                    for ($i = 0; $i < 6; $i++) {
